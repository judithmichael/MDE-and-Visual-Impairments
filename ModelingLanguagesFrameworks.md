...
- S10 created a model in XML format based on textual and their own XML-based DSL.
...
- S4, S27, and S29 use a DSL as well as both platform-independent model (PIM) and platform-specific model (PSM) approaches.
